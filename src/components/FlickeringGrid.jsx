...
export const FlickeringGrid = ({
    ...
    gridGap = 6,
    flickerChance = 0.3,
    color = "rgb(128, 26, 36)", // Default Dark Maroon dots for beige contrast
    width,
    height,
    className = "",
    maxOpacity = 0.2,
    ...
    return (
        <div ref={containerRef} className={className} style={{ width: "100%", height: "100%", position: "relative" }}>
            <canvas ref={canvasRef} style={{ width: canvasSize.width, height: canvasSize.height, display: "block" }} />
        </div>
    );
};